  ...
  <form method="post" action="search_record.php">	
    <div class="form-group form-group1">
			...
			<div class="form-group form-group1">
		      ...
		      <div class="col-sm-5">
			  <select name="caste" class="form-text" required="required">
			...
			<div class="form-group form-group1">
                <label class="col-sm-7 control-lable">Religion<span class="form-required" title="This field is required.">*</span></label>
		      <div class="col-sm-5">
			  <select name="religion" class="form-text" required="required">
			        <option value="">Select</option>
                    <option value="hindu">Hindu</option>
					<option value="sikh">Sikh</option>
					<option value="jain">Jain-All</option>
					<option value="jain">Jain-Digambar</option>
				    <option value="Verma">Verma</option>
			        <option value="Sharma">Sharma</option>
					<option value="Gupta">Gupta</option>
					<option value="Goyal">Goyal</option>
